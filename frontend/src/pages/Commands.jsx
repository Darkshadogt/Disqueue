...
export default function Commands() {
  ...
  return (
    <div className="min-h-screen bg-void-page text-primary overflow-x-hidden">
      <Helmet>
        <title>Commands — Full Command List | Disqueue</title>
        <meta
          name="description"
          content="Every Disqueue slash command, from matchmaking preferences to region and language settings, so you can find and play with the right people faster."
        />
        <link rel="canonical" href="https://disqueue.vercel.app/commands" />
      </Helmet>
      <Navbar />
